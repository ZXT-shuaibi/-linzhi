...
| profile | ✅ 已实现（基础版） | 已支持资料查询、资料编辑、个人主页信息聚合与个人发布列表 |
| rag | ⬜ 规划中 | 暂未进入当前主开发阶段 |
| trade | ⬜ 规划中 | 暂未进入当前主开发阶段 |
...
- 当前主线已完成 `auth / discover（基础版） / content / social / feed / profile（基础版）`，后续继续围绕个人主页体验、discover 稳定性和 RAG 主链展开。
